...
import com.epam.sb.students.NoSuchStudentException;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
    ...
    protected TableMapper<Student, com.epam.sb.students.model.Course> studentToCourseTableMapper;
    ...
    @Override
    public Student updateImpl(com.epam.sb.students.model.Student student)
        throws SystemException {
        student = toUnwrappedModel(student);
    ...
    protected Student toUnwrappedModel(Student student) {
        ...
        studentImpl.setGrade(student.getGrade());
     ...
     */
    @Override
    public List<com.epam.sb.students.model.Course> getCourses(long pk)
        throws SystemException {
    ...
    public void addCourses(long pk,
        List<com.epam.sb.students.model.Course> courses)
        throws SystemException {
        for (com.epam.sb.students.model.Course course : courses) {
    ...
    public void setCourses(long pk,
        ...
        try {
            ...
            for (int i = 0; i < courses.size(); i++) {
                com.epam.sb.students.model.Course course = courses.get(i);
            ...
            FinderCacheUtil.clearCache(StudentModelImpl.MAPPING_TABLE_STUDENT_STUDENTS_COURSES_NAME);
        }
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.epam.sb.students.model.Student")));
        ...
        studentToCourseTableMapper = TableMapperFactory.getTableMapper("student_Students_Courses",
