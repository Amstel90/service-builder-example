...
import com.epam.sb.students.NoSuchCourseException;
import com.epam.sb.students.model.Course;
import com.epam.sb.students.model.impl.CourseImpl;
import com.epam.sb.students.model.impl.CourseModelImpl;
...
public class CoursePersistenceImpl extends BasePersistenceImpl<Course>
    ...
    protected TableMapper<Course, com.epam.sb.students.model.Student> courseToStudentTableMapper;
    ...
    @Override
    public Course updateImpl(com.epam.sb.students.model.Course course)
     ...
     */
    @Override
    public List<com.epam.sb.students.model.Student> getStudents(long pk)
        throws SystemException {
    ...
    public void addStudents(long pk,
        List<com.epam.sb.students.model.Student> students)
        throws SystemException {
        for (com.epam.sb.students.model.Student student : students) {
    ...
    public void removeStudent(long pk,
        com.epam.sb.students.model.Student student) throws SystemException {
    ...
    public void setStudents(long pk,
        ...
        try {
            ...
            for (int i = 0; i < students.size(); i++) {
                com.epam.sb.students.model.Student student = students.get(i);
            ...
            FinderCacheUtil.clearCache(CourseModelImpl.MAPPING_TABLE_STUDENT_STUDENTS_COURSES_NAME);
        }
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.epam.sb.students.model.Course")));
        ...
        courseToStudentTableMapper = TableMapperFactory.getTableMapper("student_Students_Courses",
    ...
    public void destroy() {
        ...
        TableMapperFactory.removeTableMapper("student_Students_Courses");
    }
}
